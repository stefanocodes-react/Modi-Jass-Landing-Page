...
const Header = ({ toggleModal }) => {
  return (
    <div className="relative" id="home">
      <div className="-z-1 absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e,transparent_1px)] bg-[size:80px_80px] [mask-image:radial-gradient(ellipse_70%_50%_at_50%_50%,#000_70%,transparent_100%)]"></div>
      <Navbar />
